...
internal class DigestAuthenticatorManager
{
    ...
    public string GetDigestHeader(string digestUri, Method method)
    {
        ...
        {
            // TODO(sgartner, 2024-01-25): Should this handle "auth-conf" as well?
            throw new ArgumentOutOfRangeException("Unknown value of qop provided, unable to conform");
        }
    }
